...
- [~] **Phase 4: Inference engine** — slices 4.1 (R1 transitive exposure) + 4.2 (R2 + recursive R1 + fixpoint) + 4.3 (pluggable benchmarkable engines: naive/semi-naive/native + metrics + UI) shipped; 4.4 embedding severity imputation next, then Phase 6 portfolio.
...
| 4. Inference engine| 3/N   | Slices 4.1–4.3 done | 2026-06-12 |
